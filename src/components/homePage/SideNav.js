...
const SideNav = () => {
    ...
    useEffect(() => {
        ...
        const sectionToObserve = ['home' , 'services' , 'winterSpecials' , 'book-online' , 'testimonial' , 'contact']
                ...
                if(entry.isIntersecting){
                    sectionToObserve.map(section =>{
                        if(entry.target.id === section){
                            ...
                            const targetLi = document.querySelector(`#${section}Link`).parentElement
    ...
    return ( 
        <div className="side-nav">
            <ul className="side-nav-list">
                ...
                <li><a id='servicesLink' href="#services">SERVICES</a></li>
                <li><a id='winterSpecialsLink' href="#winterSpecials">WINTER SPECIALS</a></li>
                <li><a id='book-onlineLink' href="#book-online">BOOK NOW</a></li>
                <li><a id='testimonialLink' href="#testimonial">TESTIMONIAL</a></li>
