        ...
        <section className="services" id="services">
            <div className="row-one">
                <div className="facial">
                    ...
                    <Link to="/services" className="book-now unobserve" state={'facial'}>BOOK NOW  	&gt; </Link>
                ...
                <div className="makeup">
                    ...
                    <Link to="/services" className="book-now unobserve" state={"hair"}>BOOK NOW  	&gt; </Link>
                </div>
            ...
            <div className="row-two">
                ...
                <div className="hair-style">                
                    <h4 className="services-title fancy-border unobserve">HAIR STYLING</h4>
                    <Link to="/services" className="book-now unobserve" state={'hair'}>BOOK NOW  	&gt; </Link>
                </div>
                ...
                <div className="nails ">
                    ...
                    <Link to="/services" className="book-now unobserve" state={'nails'}>BOOK NOW  	&gt; </Link>
                </div>
