        ...
        <div className="calendar-wrapper">
          <div className="calendar-content">
            ...
            <div className="calendar">
              ...
              <button
                onClick={() => {
                  infoObj.orderDay === "" || infoObj.orderHour === ""
                    ? setInfoNeeded(true)
                    : navigate("/info-review", { state: infoObj });
                }}
          ...
          <div className="calendar-floating">
            ...
            <p className="floating-time">
              {location.state.time} | {location.state.price}
            </p>
            {orderDay && (
              <div>
                <hr />
            ...
            <button
              onClick={() => {
                infoObj.orderDay === "" || infoObj.orderHour === ""
                  ? setInfoNeeded(true)
                  : navigate("/information", { state: infoObj });
              }}
